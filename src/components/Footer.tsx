...
const Footer = () => {
    return (
        <footer className="bg-base text-dark py-12 px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-sm font-tajawal">
                            غلوة تسعد بتقديم منتجات أقرب للطبيعة .. وما عليك إلا تقبلها .. غلوة ..
                            الطعم على أصوله ..
                        </p>
                    </div>
                    ...
                    <div className="col-span-1">
                        <h3 className="text-lg font-bold mb-4 font-tajawal">روابط سريعة</h3>
                    ...
                    {/* Contact Info */}
                    <div className="col-span-1">
                        <h3 className="text-lg font-bold mb-4 font-tajawal">تواصل معنا</h3>
                        <ul className="space-y-2 font-tajawal">
                    ...
                    {/* Social Media */}
                    <div className="col-span-1">
                        <h3 className="text-lg font-bold mb-4 font-tajawal">تابعنا</h3>
