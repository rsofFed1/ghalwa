            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between align-middle flex-col text-center">
                    ...
                    <div className="flex flex-col items-center col-span-1 my-6">
                        <h3 className="text-3xl text-[#fe9a00] font-bold mb-3 font-tajawal">أقرب غلوة لك</h3>
                        <Link
                        ...
                        >
                            ...
                            <span className="font-tajawal">تواصل عبر واتساب</span>
                        </Link>
                    </div>

                    {/* Contact Info */}
                    <div className="mb-6">
                        <h3 className="text-lg text-[#fe9a00] font-bold mb-4 font-tajawal">للاستفسار و الطلب</h3>
                        <ul className="space-y-3 flex flex-col items-center font-tajawal">
                            {/* Direct Call */}
                    ...
                    {/* Social Media */}
                    <div className="">
                        <h3 className="text-md text-[#fe9a00] font-bold mb-4 font-tajawal">تابعنا على</h3>
                        <div className="flex flex-wrap justify-center gap-4 mb-4">
                            <Link href="https://www.linkedin.com/company/feedzcompany/" target="_blank" className="text-dark hover:text-gray-700 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16" aria-label='LinkedIn icon'>
                ...
                >
                    <div className="bg-amber-50 rounded-xl p-4 mt-8 shadow-sm">
                        <div className="flex flex-col items-center justify-between gap-4">
                            <p className="text-lg font-tajawal text-[#fe9a00] font-bold">
                            ...
                            <div className="text-center flex md:text-right">
                                ...
                                <span
                                    ...
                                    role='img'
                                    className="flex mr-4 items-center gap-2 text-green-600 hover:text-green-700 font-tajawal font-medium transition-colors duration-300"
                                >
